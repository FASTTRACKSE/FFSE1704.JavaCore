package ffse.khachhang.main;

import java.util.ArrayList;
import java.util.InputMismatchException;
import java.util.Scanner;

import ffse.khachhang.dao.KhachHangDao;
import ffse.khachhang.entity.KhachHang;
import ffse.khachhang.util.KHException;
...
public class QLKH {
	...
	public static void main(String[] args) {
		khachHangDAO.getConnect("localhost", "ffse1703009", "phuongnh", "phuongnh");
		menu();
	}
	...
	public static void xemThongTin() {
		...
		System.out.println(
				khachHangThanYeu.getID() + "-" + khachHangThanYeu.getMaKH() + "-" + khachHangThanYeu.getTenKH() + "-" + khachHangThanYeu.getDiaChi()
						+ "-" + khachHangThanYeu.getNgaySinh() + "-" + khachHangThanYeu.getGioiTinh() + "-" + khachHangThanYeu.getSoDT());
	}
	...
	public static void suaThongTin() {
		...
		System.out.println("------------------------------------------------------------------");
		KhachHang kh = new KhachHang(id, maKH, tenKH, diaChi, ngaySinh, gioiTinh, soDT);//đưa mọi thông tin mới vào 1 biến
