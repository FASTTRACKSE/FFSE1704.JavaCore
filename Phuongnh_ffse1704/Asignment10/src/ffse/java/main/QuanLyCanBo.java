...
public class QuanLyCanBo {
	...
	public static void main(String[] args) {
		...
		while (N != 5) {
			try {
				...
				System.out.println("|5.Lưu File danh sách cán bộ                         |");
				System.out.println("|6.Đọc File danh sách cán bộ                         |");
				...
				if (N == 1) {
					...
					System.err.println("Chỉ nhập từ 1 đến 7 thôi nhé");
				}
			} finally {
				if (N != 5) {
					BackToMainMenu();
	...
	public static void docCanBo() {
		dsCanBo.clear();
		dsCanBo = SerializeFileFactory.docFile("danhsachkhachhang.txt");
	}
	public static void luuCanBo() {
				// Lưu thông tin cán bộ ra file
