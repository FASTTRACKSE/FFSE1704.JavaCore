...
public class Menu {
	...
	public static void GiaiPTBac2() {
		...
		nhap2 = new Scanner(System.in);
		System.out.println("+------------------+");
		System.out.println("|PHƯƠNG TRÌNH BẬC 2|");
		System.out.println("+------------------+");

		System.out.println("Nhập vào số a : ");
		float a = nhap2.nextFloat();

		System.out.println("Nhập vào số b :");
		float b = nhap2.nextFloat();

		System.out.println("Nhập vào số c ");
		float c = nhap2.nextFloat();
	...
	static int i ; 
	static int j ;
	private static Scanner chon;
	private static Scanner nhap;
	private static Scanner nhap2;
	private static Scanner nhap3;
	private static Scanner nhap4;
	private static Scanner nhap5; 
