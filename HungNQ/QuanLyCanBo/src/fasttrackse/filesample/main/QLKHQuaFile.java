package fasttrackse.filesample.main;

import java.util.ArrayList;
import java.util.Scanner;

import fasttrackse.filesample.entity.KhachHang;
import fasttrackse.filesample.util.TextFileFactory;

public class QLKHQuaFile {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 2:
				...
				dsKH.clear();
				dsKH = TextFileFactory.docFile("danhsachkhachhang.txt");
				break;
			case 3:
				// Lưu thông tin khách hàng ra file
				TextFileFactory.luuFile(dsKH, "danhsachkhachhang.txt");
