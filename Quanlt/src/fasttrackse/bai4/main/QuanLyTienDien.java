package fasttrackse.bai4.main;

import java.util.*;

import fasttrackse.bai4.quanlytiendien.entity.*;
...
public class QuanLyTienDien {
	...
	public static void menu() {
		...
		while (myOption != 5) {
			try {
				...
				System.out.println("6. Sắp xếp theo ABCD...");
				System.out.println("---------------------------------------");
	...
	public static void sapXep() {
		...
		for (KhachHang x : dsKH) {
			...
			System.out.println(" Mã KH : " + x.getMaKH() + " Tên KH :" + x.getTenKH() + "\t" + "CS Cũ" + "\t" + "CS Mới"
					+ "\t" + "Tháng/Năm" + "\t" + "Tổng tiền");
			for (BienLai o : x.getDsBienLai()) {
				System.out.println("\t\t\t" + o.getMaCongTo() + " - " + o.getCkThang() + "/" + o.getCkNam() + " - "
						+ o.getCsDauKy() + "\t:\t" + o.getCsCuoiKy() + "\t->\t" + o.tinhTienTrongKy());
