...
import fasttrackse.qlkh.until.until;
...
public class QLKH {
	...
	public static void select() {
		khachHangDAO.getConnect("localhost", "test", "java", "123456");
	...
	public static void add() {
		...
		System.out.println("-------------------------------");
		System.out.print("Nhập số lượng khách hàng mà bạn muốn thêm:");
		n = nhap.nextInt();
		for (i = 0; i < n; i++) {
			...
			do {
				...
				try {
					...
					TenKH = nhap.nextLine();
					if (TenKH.length() < 1 || TenKH.length() > 45) {
	...
	public static void read() {
		...
		System.out.printf("%2s %10s %17s %15s %17s %12s %9s ", "Id", "MaKH", "TenKH", "DiaChi", "NgaySinh", "GioiTinh",
				"SoDT");
		System.out.println();
		System.out.println(khachHang.getId() + "\t " + khachHang.getMaKH() + "\t  " + khachHang.getTenKH() + "\t"
				+ khachHang.getDiaChi() + "\t" + khachHang.getNgaySinh() + "\t" + khachHang.getGioiTinh() + "\t   "
