...
public class Login extends JFrame {
	...
	Image bgImage = Toolkit.getDefaultToolkit().createImage("/ffse1703012/images/background_login.png"); 
...
//      boxMain.setBackground(Color.WHITE);
		...
		ImageIcon imgUser = new ImageIcon(getClass().getResource("/ffse1703012/images/user_icon.png"));
		...
		ImageIcon imgPass = new ImageIcon(getClass().getResource("/ffse1703012/images/pass_icon.png"));
		...
		textMatKhau.addFocusListener(new FocusListener() {
			...
			@Override
			public void focusLost(FocusEvent e) {
				char[] matKhau = textMatKhau.getPassword();
		...
		ImageIcon bntDangNhapIcon = new ImageIcon(getClass().getResource("/ffse1703012/images/btn_dangnhap.png"));
		Border thickBorder = new LineBorder(color, 1);
		btnDangNhap = new JButton("Đăng Nhập",bntDangNhapIcon);
	...
	ActionListener btnDangNhapEvents = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			String taiKhoan = textTaiKhoan.getText();
			char[] matKhau = textMatKhau.getPassword();
			String pwd = String.valueOf(matKhau);
			...
			} else if(pwd.isEmpty() || matKhau.equals("Nhập Mật Khẩu")) {
				JOptionPane.showMessageDialog(null, "Vui lòng Nhập Mật Khẩu");
				textMatKhau.requestFocus();
			} else {
				int kt = loginStatement.check(taiKhoan, pwd);
				if(kt > 0) {
