...
public class QuanLiDiem extends JPanel {
	...
	private void addControls() {
		...
		TitledBorder borderTitleChonSinhVien = BorderFactory.createTitledBorder(borderChonSinhVien,
				"Danh sách sinh viên", TitledBorder.CENTER, TitledBorder.DEFAULT_POSITION);
		...
		TitledBorder borderTitleNhapDiem = BorderFactory.createTitledBorder(borderNhapDiem, "Nhập điểm",
		...
		ImageIcon imgBtnNhap = new ImageIcon(getClass().getResource("/ffse1703012/images/btn_nhapdiem.png"));
		btnNhap = new JButton("Nhập", imgBtnNhap);
		btnNhap.setPreferredSize(new Dimension(110, 30));
		ImageIcon imgBtnSua = new ImageIcon(getClass().getResource("/ffse1703012/images/btn_sua.png"));
		btnSua = new JButton("Sửa", imgBtnSua);
		btnSua.setEnabled(false);
		btnSua.setPreferredSize(new Dimension(110, 30));
		ImageIcon imgBtnHuy = new ImageIcon(getClass().getResource("/ffse1703012/images/btn_huy.png"));
	...
	private void addEvents() {
		...
		cboMaMon.addActionListener(cboMaMonEvents);
		repaint();
