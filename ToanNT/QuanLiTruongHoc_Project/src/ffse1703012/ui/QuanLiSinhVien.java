...
public class QuanLiSinhVien extends JPanel {
	...
	private void addControl() {
		...
		ImageIcon imgBtnThem = new ImageIcon(getClass().getResource("/ffse1703012/images/btn_them.png"));
		...
		ImageIcon imgBtnXoa = new ImageIcon(getClass().getResource("/ffse1703012/images/btn_xoa.png"));
		btnXoa = new JButton("Xóa", imgBtnXoa);
		btnXoa.setEnabled(false);
		btnXoa.setPreferredSize(new Dimension(110, 30));
		ImageIcon imgBtnTaoMoi = new ImageIcon(getClass().getResource("/ffse1703012/images/btn_huy.png"));
		...
		ImageIcon imgBtnTimKiem = new ImageIcon(getClass().getResource("/ffse1703012/images/btn_search.png"));
