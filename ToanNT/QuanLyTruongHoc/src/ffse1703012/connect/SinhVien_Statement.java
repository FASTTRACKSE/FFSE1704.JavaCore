...
public class SinhVien_Statement {
	...
	public ArrayList<SinhVien> selectAllSv() {
		...
		try {
			...
			while (result.next()) {
				...
				arrSv.add(new SinhVien(maSV, hoTen, diachi, phuong, quanHuyen, tinhThanh, dienThoai, email, maLop));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void insert(String maSv, String hoTen, String diaChi, String phuong, String quanHuyen, String tinhThanh,
			String dienThoai, String email, String maLop) {
		try {
			String sql = "insert into Sinh_vien values('" + 0 + "','" + maSv + "', '" + hoTen + "', '" + diaChi + "','"
					+ phuong + "', '" + quanHuyen + "', '" + tinhThanh + "',  '" + dienThoai + "', '" + email + "', '"
					+ maLop + "')";
			Statement statement = conn.createStatement();
	...
	public void updateSv(String maSv, String hoTen, String diaChi, String phuong, String quanHuyen, String tinhThanh,
			String dienThoai, String email, String maLop) {
		try {

			String sql = "update Sinh_vien set Hoten='" + hoTen + "', Diachi='" + diaChi + "', Phuong='" + phuong
					+ "', Quanhuyen ='" + quanHuyen + "', Tinhthanh ='" + tinhThanh + "', Dienthoai ='" + dienThoai
					+ "', Email ='" + email + "', Malop ='" + maLop + "' where Masv='" + maSv + "'";
			Statement statement = conn.createStatement();
