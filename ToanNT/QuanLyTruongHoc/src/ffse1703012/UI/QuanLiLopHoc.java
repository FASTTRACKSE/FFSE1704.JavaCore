...
public class QuanLiLopHoc extends JFrame {
	...
	private ArrayList<QuanLyMonHoc> arrMon = new ArrayList<>();
	private ArrayList<QuanLyLop> arrLop = new ArrayList<>();
	private ArrayList<QuanLyMonHoc> arrPhanMon = new ArrayList<>();
	...
	private void addControl() {
		...
		tbLop.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				dm.setRowCount(0);
				for(QuanLyMonHoc x : arrPhanMon) {
					String rowPhanMon[] = {x.getTenMH(), x.getMaMH()};
