...
public class ThongKeSinhVien extends JFrame {
	public JComboBox cboNamHoc, cboMaLop;
	public DefaultTableModel dm;
	private JTable tbSinhVien;
	private JButton btnThoat;
	private ThongKeSV_Statement thongKeSinhVienStatement = new ThongKeSV_Statement();
	private ArrayList<String> arrNamHoc = new ArrayList<>();
	private ArrayList<QuanLyLop> arrMaLop = new ArrayList<>();
	private ArrayList<PhanMon> arrPhanMon = new ArrayList<>();
	private ArrayList<SinhVien> arrThongTinSv = new ArrayList<>();
	private ArrayList<DiemSV> arrDiemSv = new ArrayList<>();
	...
	private void addControls() {
		...
		TitledBorder borderTitleThongKe = BorderFactory.createTitledBorder(borderThongKe, "Báo cáo sinh viên",
