package ffse.javacore.main;

import java.util.ArrayList;
import java.util.InputMismatchException;
import java.util.Scanner;

import ffse.javacore.dao.KhachHangDAO;
import ffse.javacore.util.KhachHang;
import ffse.javacore.util.myException;
...
public class QLKH {
	...
	public static void KetNoiDB() {
		khachHangDAO.getConnect("localhost", "dbtest", "ffse1702052", "ffse1702052tung");
